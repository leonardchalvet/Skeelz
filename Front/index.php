				...
				<div class="wrapper">
					...
					<div class="container-text">
						<h2 class="wrapLine bnd">
							Les talents d'aujourd'hui sont ici. Ceux de <p>demain</p> aussi.
						</h2>
					...
					<div class="container-el">
						<div class="el container__anim">
							<div class="text">
								...
								<p class="anim__slide anim__delayMedium_2">
									Aujourd'hui, les talents sont de plus en plus indépendants, flexibles et connectés. Les entreprises doivent s'adapter et investir massivement en innovation pour se démarquer. Avec Skeelz, vous bénéficieriez des dernières technologies - IA, Blockchain - et d'experts chevronnés pour mettre la main sur les meilleurs talents de votre domaine.
								</p>
							</div>
							<div class="illu anim__fade anim__delayMedium_3">
								<img src="img/home/desc-illu-1.svg" alt="">
							</div>
						</div>
						...
						<div class="el container__anim">
							<div class="text">
								...
								<p class="anim__slide anim__delayMedium_2">
									Chez Skeelz, on bosse sans relâche pour vous dégoter la pépite. On se réunit chaque semaine pour challenger toujours et encore notre processus de recrutement. On est une team d'experts en Talent Management, Talent Acquisition... tous mordus de technologie, d’IA et de Big Data... alors forcément, on va plus vite !
								</p>
							</div>
							<div class="illu anim__fade anim__delayMedium_3">
								<img src="img/home/desc-illu-2.svg" alt="">
							</div>
						</div>
						...
						<div class="el container__anim">
							<div class="text">
								<h3 class="anim__slide anim__delayMedium_1">
									Expertise Locale, Présence Internationale
								</h3>
								<p class="anim__slide anim__delayMedium_2">
									Depuis Paris, nos équipes scrutent l'Europe entière à la recherche des meilleurs talents. Nos consultants ont accès à une base de données commune et à un réseau d'experts locaux dans tous les pays européens dans lesquels nous intervenons.
								</p>
							</div>
							<div class="illu anim__slide anim__delayMedium_3">
								<img src="img/home/desc-illu-3.png" alt="">
							</div>
						</div>
					</div>
				</div>
			...
			<section id="section-quotes" class="container__anim">
				<div class="wrapper">
					<div class="container-text">
						...
						<p class="anim__slide anim__delayMedium_2">
							Quelle que soit la taille (Startups, ETI, Grands Groupes)
						</p>
					</div>
					<div class="container">
						<div class="container-quotes">
							<div class="container-el">
								<div class="el">
									<q>
										1Skeelz a très bien cerné mes attentes, mon nouvel employeur aussi. Encore merci !
									</q>
									<div class="author">
										...
										<div class="text">
											...
											<div class="infos">
												33 ans, Marketing Guru placée chez Google
											</div>
										</div>
									</div>
								</div>
								<div class="el">
									<q>
										2Skeelz a très bien cerné mes attentes, mon nouvel employeur aussi. Encore merci !
									</q>
									<div class="author">
										<div class="pp" style="background-image: url(img/img-test/user.jpg);"></div>
										<div class="text">
								...
								<div class="el">
									<q>
										3Skeelz a très bien cerné mes attentes, mon nouvel employeur aussi. Encore merci !
									</q>
									<div class="author">
										<div class="pp" style="background-image: url(img/img-test/user.jpg);"></div>
										<div class="text">
						...
						<div class="container-logos">
							<div class="container-el">
								<div class="el position-1">
									<img src="img/home/quotes-logos/signify-logo-footer.svg" alt="">
								</div>
								<div class="el position-2">
									<img src="img/home/quotes-logos/aramisauto-logo.svg" alt="">
								</div>
								<div class="el position-3">
									<img src="img/home/quotes-logos/Group.svg" alt="">
								</div>
								<div class="el position-4">
									<img src="img/home/quotes-logos/logo_black.svg" alt="">
								</div>
								<div class="el position-5">
									<img src="img/home/quotes-logos/Sonepar_logo.svg.svg" alt="">
								</div>
								<div class="el position-6">
									<img src="img/home/quotes-logos/Backmarket.svg" alt="">
								</div>

								<div class="el position-wait wait-1">
									<img src="img/home/quotes-logos/1280px-Logo_Le_Parisien_2016.svg.svg" alt="">
								</div>
								<div class="el position-wait wait-2">
									<img src="img/home/quotes-logos/ffa50cde9b839902fe16656bf0697361-o.svg" alt="">
								</div>
								<div class="el position-wait wait-3">
									<img src="img/home/quotes-logos/carambar.svg" alt="">
								</div>
								<div class="el position-wait wait-4">
									<img src="img/home/quotes-logos/logo.svg" alt="">
								</div>
								<div class="el position-wait wait-5">
									<img src="img/home/quotes-logos/Meetic.svg" alt="">
								</div>
								<div class="el position-wait wait-6">
									<img src="img/home/quotes-logos/Netflix.svg" alt="">
								</div>
								<div class="el position-wait wait-7">
									<img src="img/home/quotes-logos/Uniqlo.svg" alt="">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="wrapper">
					<div class="container-el">
						<div class="el anim__slide anim__delayMedium_1">
							<img class="icn anim__slide anim__delayMedium_2" src="img/home/prm-icn-1.svg" alt="">
							<p class="anim__slide anim__delayMedium_3">
								Saisissez les opportunités qui correspondent réellement à vos attentes.
							</p>
							<a href="" class="btn anim__slide anim__delayMedium_4">
						...
						<div class="el anim__slide anim__delayMedium_2">
							<img class="icn anim__slide anim__delayMedium_3" src="img/home/prm-icn-2.svg" alt="">
							<p class="anim__slide anim__delayMedium_4">
								Saisissez les opportunités qui correspondent réellement à vos attentes.
							</p>
							<a href="" class="btn anim__slide anim__delayMedium_5">
								<span class="btn-text">RECRUTEZ-NOUS</span>
								<svg class="btn-arrow" viewBox="0 0 14 8">
								   <use xlink:href="img/common/arrow.svg#arrow"></use>
								</svg>
							</a>
